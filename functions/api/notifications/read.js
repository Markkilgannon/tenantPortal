...
const SF_PATH = "/services/apexrest/portal/notifications/read";
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    if (!notificationId) {
      return json({ ok: false, message: "notificationId is required." }, 400);
    }
    ...
    try {
      ...
      return json(
        {
          ok: false,
          message: "Salesforce returned non-JSON for notifications-read.",
